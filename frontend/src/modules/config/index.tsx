            ...
            <nav className='space-y-1 bg-card border border-border rounded-2xl p-2 shadow-sm'>
              {sections.map(({ id, icon: Icon, label }) => (
                <button
                  ...
                  className={`w-full text-left flex items-center gap-3 px-3.5 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${activeSection === id
          ...
          <div className='flex-1 bg-card border border-border rounded-2xl p-7 shadow-sm transition-all duration-300'>
              ...
              <form onSubmit={handleSaveProfile} className='space-y-6 animate-fadeIn'>
                            ...
                            {filteredCountries.length > 0 ? (
                              filteredCountries.map((c) => (
                                <button
                                  ...
                                  className={`w-full flex items-center justify-between px-3 py-2.5 text-xs hover:bg-muted/80 transition-colors duration-150 text-left ${phonePrefix === c.prefix ? 'bg-[#2B4FFF]/10 font-semibold text-[#2B4FFF]' : ''
                                    }`}
                                >
                ...
                <div className='pt-2'>
                  <button
                    ...
                    className={`w-full md:w-auto px-7 py-3 rounded-xl text-sm font-bold text-white shadow-lg flex items-center justify-center gap-2 transition-all duration-200 ${isSavingProfile || !hasChanges
            ...
            {activeSection === 'security' && (
              <div className='space-y-6 animate-fadeIn'>
                ...
                {/* Google user — no password banner */}
                {user?.hasPassword === false ? (
                  <div className='rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30 p-5 flex gap-4 items-start'>
                    <div className='shrink-0 w-10 h-10 rounded-xl bg-white dark:bg-blue-900/40 border border-blue-200 dark:border-blue-700 flex items-center justify-center shadow-sm'>
                    ...
                    <div className='flex-1 min-w-0'>
                      <p className='text-sm font-bold text-blue-900 dark:text-blue-100'>Cuenta vinculada con Google</p>
                      <p className='text-xs text-blue-700 dark:text-blue-300 mt-1 leading-relaxed'>
                        Tu cuenta fue creada mediante inicio de sesión con Google, por lo que <span className='font-semibold'>no tienes una contraseña</span> configurada en esta plataforma. La seguridad de tu acceso es gestionada directamente por Google.
                      </p>
                      <p className='text-[11px] text-blue-600/80 dark:text-blue-400/80 mt-2.5 font-medium'>
                        Para cambiar tu contraseña, visita{' '}
                        <a
                          href='https://myaccount.google.com/security'
                          target='_blank'
                          rel='noopener noreferrer'
                          className='underline underline-offset-2 hover:text-blue-800 dark:hover:text-blue-200 transition-colors'
                        >
                    ...
                    <div className='space-y-1.5'>
                      ...
                      <div className='relative'>
                        ...
                        <input
                          ...
                          required
                        />
                        <button type='button' onClick={() => setShowCurrentPass(!showCurrentPass)} className='absolute inset-y-0 right-0 pr-3 flex items-center text-muted-foreground/60 hover:text-foreground transition-colors'>
                    ...
                    <div className='space-y-1.5'>
                      ...
                      <div className='relative'>
                        ...
                        <input
                          ...
                          required
                        />
                        <button type='button' onClick={() => setShowNewPass(!showNewPass)} className='absolute inset-y-0 right-0 pr-3 flex items-center text-muted-foreground/60 hover:text-foreground transition-colors'>
                    ...
                    <div className='space-y-1.5'>
                      ...
                      <div className='relative'>
                        ...
                        <input
                          ...
                          required
                        />
                        <button type='button' onClick={() => setShowConfirmPass(!showConfirmPass)} className='absolute inset-y-0 right-0 pr-3 flex items-center text-muted-foreground/60 hover:text-foreground transition-colors'>
                ...
                <div className='border-t border-border/60 pt-6'>
                  ...
                  <button type='button' className='text-xs border border-border rounded-xl px-4.5 py-2.5 hover:bg-muted font-bold transition-all active:scale-[0.98]'>
                    Activar 2FA
                  </button>
                </div>
              </div>
